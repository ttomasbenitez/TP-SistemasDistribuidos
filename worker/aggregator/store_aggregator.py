...
class StoreAggregator(Worker):
    ...
    def __on_message__(self, message):
        try:
            ...
            self._send_groups(message, groups, self.data_out_queue)
        except Exception as e:
...
def main():
    ...
    aggregator = StoreAggregator(config_params["expected_acks"], data_input_queue, data_output_queue, eof_input_queues, eof_output_queues)
    aggregator.start()
