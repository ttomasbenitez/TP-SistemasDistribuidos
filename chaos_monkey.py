...
EXCLUDED_CONTAINERS = ['rabbitmq', 'gateway', 
                       ...
                       'joiner-stores-q2', 'joiner-stores-q3',
                       'joiner-stores-q4', 'aggregator-store-q1', 
                       'aggregator-store-q2', 'aggregator-store-q3', 
                       'aggregator-store-q4', 'aggregator-store-eof-service',
                       'joiner-users-1', 'joiner-users-2', 'aggregator-users-1',
                       'aggregator-users-2', 'aggregator-users-eof-service', 'joiner-batches-1', 
                       'joiner-batches-2', 'aggregator-batches-1', 'aggregator-batches-2', 
                       'aggregator-batches-eof-service', 'health-monitor-1', 'health-monitor-2', 
                       'health-monitor-3']
